...
class FuncaoFamiliarView(ttk.Frame):
    def __init__(self, parent, controller: FuncaoFamiliarController):
    ...
    def _create_widgets(self):
        ...
        ttk.Label(form_frame, text="Função Familiar:").grid(row=1, column=0, sticky=tk.W, pady=2)
    ...
    def _load_data(self):
        ...
        for ff in self.controller.listar():
            self.tree.insert('', tk.END, values=(ff.get_id(), ff.get_nome()))
    ...
    def incluir(self):
        ...
        self._limpar()
        self._load_data()
        messagebox.showinfo("Sucesso", "Função familiar incluída!")
    ...
    def alterar(self):
        ...
        self._limpar()
        self._load_data()
        messagebox.showinfo("Sucesso", "Função familiar alterada!")
    ...
    def remover(self):
        ...
        if messagebox.askyesno("Confirmar", "Tem certeza que deseja remover?"):
            try:
                ...
                self._limpar()
                self._load_data()
                messagebox.showinfo("Sucesso", "Função familiar removida!")
