...
class CategoriaView(ttk.Frame):
    def __init__(self, parent, controller: CategoriaController):
    ...
    def _create_widgets(self):
        ...
        ttk.Label(form_frame, text="Nome da Categoria:").grid(row=1, column=0, sticky=tk.W, pady=2)
    ...
    def _load_data(self):
        ...
        for t in self.controller.listar():
            self.tree.insert('', tk.END, values=(t.get_id(), t.get_nome()))
    ...
    def incluir(self):
        ...
        self._limpar()
        self._load_data()
        messagebox.showinfo("Sucesso", "Categoria incluída!")
    ...
    def alterar(self):
        ...
        self._limpar()
        self._load_data()
        messagebox.showinfo("Sucesso", "Categoria alterada!")
